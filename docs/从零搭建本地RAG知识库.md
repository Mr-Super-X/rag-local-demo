...
> 想更系统地理解 RAG 的 What/Why/How，以及向量、维度、相似度等核心概念？请阅读 **[理解 RAG：从概念到实践](理解RAG-从概念到实践.md)**。
...
> 对上面提到的向量、维度、余弦相似度、Embedding 模型等概念想深入了解？**[理解 RAG：从概念到实践 §四](理解RAG-从概念到实践.md)** 用 8 个小节逐一拆解了这些核心概念。
